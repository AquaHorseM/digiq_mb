...
class RewardNet(nn.Module):
    def __init__(self, state_dim:int, action_dim:int, goal_dim:int, embed_dim, 
        ...
        self.value = ValueNet(state_dim=state_dim, goal_dim=goal_dim, embed_dim=embed_dim, num_attn_layers=num_attn_layers_value, num_heads=num_heads_value, device=device)
